...
fun LearnScreen(
    ...
    Column(
        ...
        // 4 варианта ответа
        val answers = listOf(
            1 to currentNote.answer1De to currentNote.answer1Native,
            2 to currentNote.answer2De to currentNote.answer2Native,
            3 to currentNote.answer3De to currentNote.answer3Native,
            4 to currentNote.answer4De to currentNote.answer4Native
        )
