...
data class AppStringsImpl(
    ...
    override val bundeslandSelectTitle: String,
    override val bundeslandSelectPrompt: String,
    override val bundeslandSection: String,
    override val dashboardTitle: String,
    override val studyQuestions: String,
    override val allQuestions: String,
    override val generalQuestions: String,
    override val regionalQuestions: String,
...
fun rememberAppStrings(languageConfig: AppLanguageConfig): AppStrings {
    return AppStringsImpl(
        ...
        bundeslandSelectTitle = stringResource(Res.string.bundesland_select_title),
        bundeslandSelectPrompt = stringResource(Res.string.bundesland_select_prompt),
        bundeslandSection = stringResource(Res.string.bundesland_section),
        dashboardTitle = stringResource(Res.string.dashboard_title),
        studyQuestions = stringResource(Res.string.study_questions),
        allQuestions = stringResource(Res.string.all_questions),
        generalQuestions = stringResource(Res.string.general_questions),
        regionalQuestions = stringResource(Res.string.regional_questions),
        favorites = stringResource(Res.string.favorites),
        ...
        lessonTitle = stringResource(Res.string.lesson_title),
        ...
        languageContentSection = stringResource(Res.string.language_content_section),
        ...
        showCorrectImmediately = stringResource(Res.string.show_correct_immediately),
